<?php 
    ...
    $id = $_POST['idDigitado'];
    $sql = "select * from quartos where quartos.idBedroom = '$id'";
        ...
        <?php
            ...
            echo "
                <form method='post' action='bdQuartos.php' class='formulario'>
                    $quarto[0]
                    <input name='numero' value='$quarto[1]' class='textoArea'>
                    <input name='tipo' value='$quarto[2]' class='textoArea'> 
                    <input name='valor' value='$quarto[3]' class='textoArea'>
                    <input name='statusQuarto' value='$quarto[4]' class='textoArea'>
